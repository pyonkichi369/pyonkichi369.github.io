...
※ IDispatch：事実上ほかのあらゆるCOMインターフェイスを呼び出し可能なように設計されたCOMインターフェイスのこと。
...
エンジニアを目指すなら覚えておきたい英単語に範囲を絞りましたが数が多いので、今回は頭文字がCの単語に絞って例文を使って解説しました。

次の記事では、頭文字がDの単語に絞って解説をしようと思います。
